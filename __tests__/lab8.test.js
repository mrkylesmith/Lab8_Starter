describe('Basic user flow for Website', () => {
  ...
  it('Make sure <product-item> elements are populated', async () => {
    ...
    // Check if all 20 <product-item> elements have data
  ...
  it('Clicking the "Add to Cart" button should change button text', async () => {
    ...
    let elemShadowRoot = await productItem.getProperty('shadowRoot'); 
    let button = await elemShadowRoot.$('button');
    ...
    // Reset product item state to "Add to Cart" and verify
    await button.click();
  ...
  it('Checking number of items in cart on screen', async () => {
    ...
    for (let i = 0; i < prodItems.length; ++i) {
        let elemShadowRoot = await prodItems[i].getProperty('shadowRoot');
        let button = await elemShadowRoot.$('button');
        await button.click();
    }
